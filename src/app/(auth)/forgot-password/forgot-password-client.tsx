...
import { RECOVERY_SENT_MESSAGE, submitRecoveryRequest } from "./utils";
...
export function ForgotPasswordClient() {
	...
	return (
		<AuthShell
			...
			description="Give the address you sign in with. We send the reset link to the recovery email on the account."
